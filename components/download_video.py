def download_video(
    ...
    """
    Downloads the video from the s3 bucket.
    ...
    video_file    = os.path.join(artifacts_directory, os.path.basename(s3_video_file))
    ...
    s3_client.download_file(s3_bucket, s3_video_file, video_file)
